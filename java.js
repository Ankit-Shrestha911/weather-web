  ...
  if (navigator && navigator.geolocation) {
    navigator.geolocation.getCurrentPosition((poistion) => {
      ...
      fetch(apiUrl)
        ...
        //Display date time //
        date_time.textContent = `${today.toLocaleDateString("en-US", d)}-${today.toLocaleDateString("en-US", m)}-${today.toLocaleDateString("en-US", y)} ${today.toLocaleDateString("en-US", options)}`;
